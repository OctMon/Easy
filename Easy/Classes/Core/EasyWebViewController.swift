    ...
    open override func viewDidLoad() {
        ...
        webView.do {
            ...
            $0.snp.makeConstraints({ (make) in
                make.edges.equalToSuperview().inset(UIEdgeInsets(top: navigationBarHidden ? EasyApp.statusBarHeight : (self.navigationBar?.backgroundImage(for: .default) == nil ? navigationBottom : 0), left: 0, bottom: 0, right: 0))
                if #available(iOS 11, *) {
                } else {
